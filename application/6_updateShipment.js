 ...
 */
async function main(buyerCRN, drugName, transporterName, transporterCRN, organisationRole) {
	...
	try {
		...
		const updatedShipmentBuffer = await pharmanetContract.submitTransaction('updateShipment', buyerCRN, drugName, transporterName, transporterCRN);
